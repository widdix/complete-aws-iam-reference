...
(function() {
  ...
  a.controller('PageGlobalConditionsController', ['$log', function($log) {
  ...
  a.config(function($routeProvider) {
    $routeProvider
      ...
      .when('/reference/:service', {
        templateUrl: './partial/reference.html',
        controller: 'PageReferenceController',
        section: 'reference'
      })
      .when('/global_conditions', {
        templateUrl: './partial/global_conditions.html',
        controller: 'PageGlobalConditionsController',
